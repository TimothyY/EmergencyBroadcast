...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Location location = intent.getParcelableExtra(FetchAddressIntentService.Constants.LOCATION_DATA_EXTRA);
        ...
        if (location == null) {
            ...
            deliverResultToReceiver(FetchAddressIntentService.Constants.FAILURE_RESULT, errorMessage);
            return;
        }
    ...
    public static final class Constants {
        ...
        public  static final String PACKAGE_NAME = "com.timeandtidestudio.emergencybroadcast";
